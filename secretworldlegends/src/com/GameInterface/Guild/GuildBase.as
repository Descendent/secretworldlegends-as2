...
intrinsic class com.GameInterface.Guild.GuildBase
{
	...
	static public function CloseGuildWindow() : Void;

	static public function HasGuild() : Boolean;

	static public function LeaveGuild() : Void;

	static public function OpenRankingsWindow() : Void;

	static public function CloseRankingsWindow() : Void;
